...
import com.zhaoyan.gesture.music.MusicUtils.ServiceToken;
...
private static final String EXTERNAL_SD_PATH = Environment.getExternalStorageDirectory().getPath();
    ...
    public void init(Cursor newCursor, boolean isLimited) {
        ...
        if (mTrackCursor.getCount() == 0 && MusicUtils.canDisplayHintMessage(mTimeSpan)) {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case USE_AS_RINGTONE2:
                ...
                MusicUtils.setRingtone(this, item.getItemId() == USE_AS_RINGTONE, mSelectedId);
                return true;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mPlaylist != null) {
            ...
            if (mPlaylist.equals("nowplaying")) {
                ...
                menu.add(0, GROUP_ADD, 0, R.string.group_add).setIcon(R.drawable.ic_menu_group_add);
                menu.add(0, GROUP_DELETE, 0, R.string.group_delete).setIcon(R.drawable.ic_menu_group_delete);
            }
        }
        menu.add(0, EXIT_APP, 0, R.string.exit).setIcon(R.drawable.ic_menu_exit);
        mMenu = menu;
        return true;
    }
