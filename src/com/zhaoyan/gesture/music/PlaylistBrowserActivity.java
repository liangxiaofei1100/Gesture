    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public void init(Cursor cursor) {
        ...
        if (mPlaylistCursor.getCount() == 0 && MusicUtils.canDisplayHintMessage(mTimeSpan)) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mCreateShortcut) {
            menu.add(0, NEW_PLAYLIST, 0, R.string.new_playlist)
                .setIcon(R.drawable.ic_menu_new_playlist);
            menu.add(0, DELETE_PLAYLIST, 0, R.string.delete_playlist)
                .setIcon(R.drawable.ic_menu_delete_playlist);
