...
public class VideoBrowserActivity extends ListActivity implements
		MusicUtils.Defs {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		intent.setDataAndType(ContentUris.withAppendedId(
				MediaStore.Video.Media.EXTERNAL_CONTENT_URI, id), type);
	...
	private void MakeCursor() {
		String[] cols = new String[] { MediaStore.Video.Media._ID,
				...
				MediaStore.Video.Media.MIME_TYPE, MediaStore.Video.Media.ARTIST };
