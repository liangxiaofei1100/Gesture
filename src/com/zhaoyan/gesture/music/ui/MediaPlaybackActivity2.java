...
import com.zhaoyan.gesture.music.views.RepeatingImageButton;

public class MediaPlaybackActivity2 extends Activity implements MusicUtils.Defs,
	...
	public void onCreate(Bundle icicle) {
		...
		mAlbum = (ImageView) findViewById(R.id.audio_player_album_art);
		mArtistName = (TextView) findViewById(R.id.audio_player_artist);
		...
		mPrevButton = (RepeatingImageButton) findViewById(R.id.audio_player_prev);
		mPrevButton.setOnClickListener(mPrevListener);
		mPrevButton.setRepeatListener(mRewListener, 260);
		mPauseButton = (ImageButton) findViewById(R.id.audio_player_play);
		mPauseButton.requestFocus();
		mPauseButton.setOnClickListener(mPauseListener);
		mNextButton = (RepeatingImageButton) findViewById(R.id.audio_player_next);
...
//		mQueueButton.setOnClickListener(mQueueListener);
	...
	private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
		...
		public void onProgressChanged(SeekBar bar, int progress,
			...
			if ((now - mLastSeekEventTime) > 12) {
				mLastSeekEventTime = now;
				mPosOverride = mDuration * progress / 1000;
				/*
				 * try { mService.seek(mPosOverride); } catch (RemoteException
				 * ex) { }
				 */
...
//				}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (MusicUtils.getCurrentAudioId() >= 0) {
			...
			menu.add(0, CURRENT_PLAYLIST, 0, "播放列表").setIcon(R.drawable.ic_mp_current_playlist_btn).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
			...
			case USE_AS_RINGTONE:
				...
				if (mService != null) {
					MusicUtils.setRingtone(this,
							item.getItemId() == USE_AS_RINGTONE,
							mService.getAudioId());
				}
				return true;
			case PARTY_SHUFFLE:
...
//					mQueueButton.setVisibility(View.VISIBLE);
			...
			if (getIntent().getData() == null) {
				...
				intent.setClass(MediaPlaybackActivity2.this,
	...
	private final Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case QUIT:
				...
				new AlertDialog.Builder(MediaPlaybackActivity2.this)
	...
	public class AlbumArtHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == GET_ALBUM_ART
				...
				Bitmap bm = MusicUtils.getArtwork(MediaPlaybackActivity2.this,
						songid, albumid, false);
				if (bm == null) {
					bm = MusicUtils.getArtwork(MediaPlaybackActivity2.this,
							songid, -1);
					albumid = -1;
				}
				if (bm != null) {
