...
import com.zhaoyan.gesture.music.views.TouchInterceptor;
import com.zhaoyan.gesture.music.views.TouchInterceptor.DropListener;
import com.zhaoyan.gesture.music.views.TouchInterceptor.RemoveListener;
...
public class TrackBrowserActivity extends ListActivity implements
	...
	private static final int GROUP_DELETE = CHILD_MENU_BASE + 8;
...
//				MusicUtils.updateNowPlaying(TrackBrowserActivity.this);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (mPlaylist == null) {
			menu.add(0, PLAY_ALL, 0, R.string.play_all).setIcon(
		...
		if (mPlaylist != null) {
			...
			} else if (!(mPlaylist.equals("recentlyadded") || mPlaylist
					.equals("podcasts"))) {
				menu.add(0, GROUP_ADD, 0, R.string.group_add).setIcon(
						R.drawable.ic_menu_group_add);
				menu.add(0, GROUP_DELETE, 0, R.string.group_delete).setIcon(
						R.drawable.ic_menu_group_delete);
			}
		}
	...
	private void updateMenu(Menu menu) {
		...
		MenuItem item = menu.findItem(GROUP_DELETE);
		if (item != null) {
			item.setVisible(mTrackCursor != null && mTrackCursor.getCount() > 0);
		}
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case GROUP_DELETE:
			if (Environment.MEDIA_MOUNTED.equals(Environment
				...
				intent = new Intent(this, GroupOperateActivity.class);
				intent.putExtra("operate_id", item.getItemId());
		...
		class TrackQueryHandler extends AsyncQueryHandler {
			...
			protected void onQueryComplete(int token, Object cookie,
				...
				try {
					...
					Log.i(LOGTAG, "StaleDataException");
				}
			}
		}
