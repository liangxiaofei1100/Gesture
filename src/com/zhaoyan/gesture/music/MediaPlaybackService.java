...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.zhaoyan.gesture.music.playstatechanged";
    public static final String META_CHANGED = "com.zhaoyan.gesture.music.metachanged";
    public static final String QUEUE_CHANGED = "com.zhaoyan.gesture.music.queuechanged";

    public static final String SERVICECMD = "com.zhaoyan.gesture.music.musicservicecommand";
...
//                }
    ...
    public void play() {
        ...
        Log.d(LOGTAG,"CallState:" + tm.getCallState());
        if(tm.getCallState() != TelephonyManager.CALL_STATE_IDLE) {
            Toast.makeText(this, R.string.not_play_in_call, Toast.LENGTH_LONG).show();
            return;
        }
