...
implements MusicUtils.Defs, ServiceConnection
{
    ...
    public void init(Cursor c) {
        ...
        if (mQueryCursor.getCount() == 0 && MusicUtils.canDisplayHintMessage(mTimeSpan)) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case USE_AS_RINGTONE: {
                ...
                MusicUtils.setRingtone(this, item.getItemId() ==  USE_AS_RINGTONE, mTrackList.getSelectedItemId());
                return true;
            }
